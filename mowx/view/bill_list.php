                ...
                ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <!--<a href="?mod=customer&act=detail&code=<?= $row['customer_code'] ?>" class="btn btn-primary"><i class="fas fa-eye"></i></a>-->
                            <a href="?mod=bill&act=edit&code=<?= $row['bill_code'] ?>" class="btn btn-success"><i class="fas fa-edit"></i></a>
                            <a href="?mod=bill&act=delete&code=<?= $row['bill_code'] ?>" class="btn btn-danger"><i class="fas fa-trash"></i></a>
                            <a href="?mod=bill&act=delete&code=<?= $row['bill_code'] ?>" class="btn btn-success btn-delete"><i class="fas fa-trash"></i></a>
                        </td>
                    </tr>
                    <?php
                    }
