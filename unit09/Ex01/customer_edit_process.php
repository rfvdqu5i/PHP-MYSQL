<?php 
    ...
    if(isset($_POST['submit'])){ // kiểm tra xem button Submit đã được click hay chưa ? 
        $uploads = file_upload("img/customer","IMG",500000,array('JPG', 'png', 'jpg'));
...
//        }
	...
	$query = "UPDATE customers SET NAME='".$data['NAME']."', EMAIL='".$data['EMAIL']."', MOBILE='".$data['MOBILE']."', ADDRESS='".$data['ADDRESS']."', IMG='".$_FILES['IMG']['name']."' WHERE CODE='".$data['CODE']."' ";
