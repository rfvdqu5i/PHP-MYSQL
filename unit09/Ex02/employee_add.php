...
<body>
    <div class="container">
        ...
        <hr>
        <form action="employee_add_process.php" method="POST" role="form" enctype="multipart/form-data">
            <div class="form-group">
                <label for="">Mã nhân viên</label>
                <input type="text" class="form-control" id="" placeholder="Nhập vào mã nhân viên" name="CODE">
            </div>
            <div class="form-group">
